...
std::vector<fieldstruct> DataFrame::fieldsidentifier(std::ifstream &file, char delimiter)
{
...
void DataFrame::datacounter(std::ifstream &file)
{
    std::string line;
    rowscount = 0;
    do
...
void DataFrame::createDataFrame(std::ifstream &file, char delimiter)
{
    Row row;
    Cell cell;
    std::string line;
...
void DataFrame::read_csv(const std::string &filename, char delimiter)
{
...
void DataFrame::save(const std::string &filename)
{
...
void DataFrame::change_value(std::string field_name, int row_index, const Cell &new_value)
{
...
void DataFrame::sort(int column_index, bool ascending)
{
    if (column_index < 0 || column_index >= fieldcount)
    {
        cout << "Invalid column index.\n";
